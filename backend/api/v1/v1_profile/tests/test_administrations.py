...
class AdministrationTestCase(TestCase, ProfileTestHelperMixin):
    ...
    def test_update(self):
        ...
        test_adm = Administration.objects.create(parent=adm_level_2, name='Test', code='T', level=level_3)
        payload = {'parent': adm_level_1.id, 'name': 'Test renamed', 'code': 'TR'}
    ...
    def test_delete(self):
        level_2 = Levels.objects.get(level=2)
        adm_level_1 = Administration.objects.get(level__level=1)
        test_adm = Administration.objects.create(parent=adm_level_1, name='Test', code='T', level=level_2)
        ...
        self.assertFalse(Administration.objects.filter(id=test_adm.id).exists())

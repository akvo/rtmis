...
class ProfileTestHelperMixin:
    ...
    def create_user(self, email: str, role_level: int, password: str='password') -> SystemUser:
    ...
    def reset_db_sequence(*models):
        """
        Auto fields are no longer incrementing after running create with explicit id parameter
    ...
    def get_auth_token(self: HasTestClientProtocol, email: str, password: str='password') -> str:

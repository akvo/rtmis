...
const UploadEntitiesData = () => {
  ...
  const uploadRequest = ({ file, onSuccess }) => {
    ...
    setUploading(true);
    api
      .post(`upload/bulk-entities`, formData)
      .then((res) => {
        onSuccess(res.data);
      })
      .catch(() => {
      ...
      <div className="description-container">
        <Row justify="space-between">
          <Col>
            ...
            <DescriptionPanel
              description={text.dataEntitiesUploadText}
              title={text.EntitiesDataUpload}
            />
          </Col>
        </Row>
        ...
        <div className="table-wrapper">
          {showSuccess && (
            ...
            >
              <Result
                status="success"
                title={text.entitiesUploadSuccessTitle}
                extra={[
                  <Divider key="divider" />,
                  <Button
                    type="primary"
...
export default React.memo(UploadEntitiesData);

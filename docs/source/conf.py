...
# -*- coding: utf-8 -*-
#
# RTMIS documentation build configuration file, created by
# sphinx-quickstart on Wed May 25 02:24:27 2022.
#
...
latex_documents = [
    (master_doc, 'RTMIS.tex', 'RTMIS Documentation',
     'Akvo', 'manual'),
]
...
man_pages = [
    (master_doc, 'rtmis', 'RTMIS Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'RTMIS', 'RTMIS Documentation',
     author, 'RTMIS', 'One line description of project.',
     'Miscellaneous'),
]
